...
// The following handlers are for dynamic routes and should be documented in their respective files:
/**
 * @swagger
 * /api/events/{id}:
 *   get:
...
/**
 * @swagger
 * /api/events/job/{jobId}/stats:
 *   get:
 *     summary: Fetch event counts for a specific job
 *     tags:
 *       - Events
 *     parameters:
 *       - in: path
...
/**
 * @swagger
 * /api/events/aggregations:
 *   get:
 *     summary: Fetch aggregated event counts
 *     tags:
 *       - Events
 *     parameters:
 *       - in: query
